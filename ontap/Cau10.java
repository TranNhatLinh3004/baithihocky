...
public class Cau10 {
    public static void main(String[] args) {
        ...
        System.out.println("có " + dem + " số phần tử chia hết cho 5 và không chia hết cho 6");
        ...
        System.out.println("Có " + Dem + " số phần tử số lẻ");
        ...
        System.out.println("Các phần tử số lẻ trong mảng C là: ");
        for (int i = 0; i < j; i++) {
